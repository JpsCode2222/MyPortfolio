                                    ...
                                    <div className="row">
                                        <div className='col-12 col-md-6 pr-5'>
                                            <div className='ml-5 profilediv' style={{ boxShadow: '5px 50px 100px 50px', backgroundColor: 'white', height: '300px', width: '300px', borderRadius: '50%', border: '15px solid silver' }}>
                                                <img src="https://media.istockphoto.com/id/1366725032/photo/smiling-teenager-taking-notes-while-using-laptop-during-a-class-at-high-school.jpg?b=1&s=612x612&w=0&k=20&c=SQoLizvrXEvIZrNYpyPv33ZlfP32SSvPpqqcGVC9PPo=" id="img" alt="" style={{overflow:'hidden'}}/>
                                            </div>
                                        </div>
